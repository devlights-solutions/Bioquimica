...
{
    public partial class ucPorcentaje : UserControl
    {
        public ucPorcentaje()
        {
            InitializeComponent();
        ...
        private void TextBox1OnLostFocus(object sender, EventArgs eventArgs)
        {
            if (!string.IsNullOrEmpty(TextBox1.Text))
            {
                ...
                {
                    TextBox1.Text = String.Format("{0}%", Convert.ToDecimal(TextBox1.Text.Replace(".", ",")).ToString("N2"));
                }
                else
                {
                    TextBox1.Text = "";
        ...
        public decimal? Valor
        {
            get
            {
                if (string.IsNullOrEmpty(TextBox1.Text))
                    return null;
                return Convert.ToDecimal(TextBox1.Text.Replace("%", "").Replace(".", ""));
            }
            set
            {
                if (value != null)
